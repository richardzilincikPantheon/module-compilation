...
# Yumaworks
YANG-generic.py --allinclusive True --metadata "YUMAWORKS: YANG Data Models compilation from https://github.com/YangModels/yang/tree/master/vendo
r/yumaworks" --lint True --prefix YUMAWORKS --rootdir "$NONIETFDIR/yangmodels/yang/vendor/yumaworks/" >> $LOG 2>&1
