...
# Huawei
YANG-generic.py --allinclusive True --metadata "HUAWEI ROUTER 8.9.10 https://github.com/Huawei/yang/tree/master/network-router/8.9.10" --lint True --prefix NETWORKROUTER8910 --rootdir "$NONIETFDIR/yangmodels/yang/vendor/huawei/network-router/8.9.10" >> $LOG 2>&1
